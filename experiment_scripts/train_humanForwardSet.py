...
dataset = dataio.ReachabilityHumanForward(numpoints=65000, collisionR=opt.collisionR, velocity=opt.velocity, 
...
# Define the loss
loss_fn = loss_functions.initialize_hji_human_forward(dataset, opt.minWith)
