...
model = modules.SingleBVPNet(in_features=31, out_features=1, type=opt.model, mode=opt.mode,
...
def val_fn(model, ckpt_dir, epoch):
  ...
  for i in range(num_times):
    ...
    amax1_coords = torch.ones(mgrid_coords.shape[0], 1) * (0.0 - beta['a'])/alpha['a'] 
    amin2_coords = torch.ones(mgrid_coords.shape[0], 1) * (0.0 - beta['a'])/alpha['a'] 
    amax2_coords = torch.ones(mgrid_coords.shape[0], 1) * (0.0 - beta['a'])/alpha['a'] 
    amin3_coords = torch.ones(mgrid_coords.shape[0], 1) * (0.0 - beta['a'])/alpha['a'] 
    amax3_coords = torch.ones(mgrid_coords.shape[0], 1) * (0.0 - beta['a'])/alpha['a'] 
    amin4_coords = torch.ones(mgrid_coords.shape[0], 1) * (0.0 - beta['a'])/alpha['a'] 
    amax4_coords = torch.ones(mgrid_coords.shape[0], 1) * (0.0 - beta['a'])/alpha['a'] 
    amin5_coords = torch.ones(mgrid_coords.shape[0], 1) * (0.0 - beta['a'])/alpha['a'] 
    amax5_coords = torch.ones(mgrid_coords.shape[0], 1) * (0.0 - beta['a'])/alpha['a'] 
    amin6_coords = torch.ones(mgrid_coords.shape[0], 1) * (0.0 - beta['a'])/alpha['a'] 
    amax6_coords = torch.ones(mgrid_coords.shape[0], 1) * (0.0 - beta['a'])/alpha['a'] 
    ...
    omin2_coords = torch.ones(mgrid_coords.shape[0], 1) * (-3.0 - beta['o'])/alpha['o']
    omax2_coords = torch.ones(mgrid_coords.shape[0], 1) * (3.0  - beta['o'])/alpha['o']
    omin3_coords = torch.ones(mgrid_coords.shape[0], 1) * (-3.0 - beta['o'])/alpha['o']
    omax3_coords = torch.ones(mgrid_coords.shape[0], 1) * (3.0  - beta['o'])/alpha['o']
    omin4_coords = torch.ones(mgrid_coords.shape[0], 1) * (-3.0 - beta['o'])/alpha['o']
    omax4_coords = torch.ones(mgrid_coords.shape[0], 1) * (3.0  - beta['o'])/alpha['o']
    omin5_coords = torch.ones(mgrid_coords.shape[0], 1) * (-3.0 - beta['o'])/alpha['o']
    omax5_coords = torch.ones(mgrid_coords.shape[0], 1) * (3.0  - beta['o'])/alpha['o']
    for j in range(num_controls):
      omin6_coords = torch.ones(mgrid_coords.shape[0], 1) * (-controls[j] - beta['o'])/alpha['o']
      omax6_coords = torch.ones(mgrid_coords.shape[0], 1) * (controls[j]  - beta['o'])/alpha['o']
      coords = torch.cat((time_coords, mgrid_coords,theta_coords,v_coords, x_coords, y_coords, amin1_coords, amax1_coords,omin1_coords, omax1_coords,amin2_coords, amax2_coords,omin2_coords, omax2_coords,
      amin3_coords, amax3_coords,omin3_coords, omax3_coords,amin4_coords, amax4_coords,omin4_coords, omax4_coords,amin5_coords, amax5_coords,omin5_coords, omax5_coords, amin6_coords, amax6_coords,omin6_coords, omax6_coords), dim=1) 
      ...
      ax.set_title('t = %0.2f, omax2 = %0.2f' % (times[i], controls[j]))
